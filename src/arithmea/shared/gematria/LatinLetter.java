...
public enum LatinLetter {
    ...
    A(new int[] {1, 1,  1,  1,  5, 1,   1}, "Gemini"),
    B(new int[] {2, 2,  2, 20, 20, 0, 200}, "Earth"),
    C(new int[] {3, 3,  3, 13,  2, 0,  40}, "Ophiuchus"), //formerly Neptune
    D(new int[] {4, 4,  4,  6, 23, 0,   6}, "Taurus"),
    E(new int[] {5, 5,  5, 25, 13, 2, 700}, "Earth"),
    F(new int[] {8, 6,  6, 18, 12, 0,  90}, "Sol"),
    G(new int[] {3, 7,  7, 11, 11, 7,  20}, "Virgo"),
    H(new int[] {5, 8,  8,  4,  3, 8,   4}, "Aquarius"),
    I(new int[] {1, 9,  9, 23, 26, 3, 400}, "Fire"), //formerly Air
    J(new int[] {1, 1, 10, 16,  7, 0,  70}, "Saturn"),
    K(new int[] {2, 2, 11,  9, 17, 0,   9}, "Libra"),
    L(new int[] {3, 3, 12,  2,  1, 9,   2}, "Capricorn"),
    M(new int[] {4, 4, 13, 21, 21, 0, 300}, "Jupiter"),
    N(new int[] {5, 5, 14, 14, 24, 0,  50}, "Mercury"),
    O(new int[] {7, 6, 15, 19, 10, 4,   7}, "Aries"),
    P(new int[] {8, 7, 16, 26,  4, 0, 800}, "Spirit"),
    Q(new int[] {1, 8, 17, 17, 16, 0, 100}, "Luna"),
    R(new int[] {2, 9, 18, 12, 14, 0,  30}, "Pisces"),
    S(new int[] {3, 1, 19,  5, 15, 6,   5}, "Scorpio"),
    T(new int[] {4, 2, 20, 24,  9, 0, 600}, "Water"),
    U(new int[] {6, 3, 21, 17, 25, 5,  80}, "Mars"),
    V(new int[] {6, 4, 22, 10, 22, 0,  10}, "Cancer"),
    W(new int[] {6, 5, 23,  3,  8, 0,   3}, "Sagittarius"),
    X(new int[] {5, 6, 24, 22,  6, 0, 500}, "Air"), //formerly Fire
    Y(new int[] {1, 7, 25, 15, 18, 7,  60}, "Venus"),
    Z(new int[] {7, 8, 26,  8, 19, 0,   8}, "Leo");
     ...
     * @param eqSign
     */
    private LatinLetter(final int[] values, final String eqSign) {
