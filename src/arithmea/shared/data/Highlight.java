...
public enum Highlight {
    ...
    seventy(70, "weird number", "purple"),
    ...
    oneHundredAndTwentyOne(121, "11*11", "yellow"),
    oneHundredAndTwentyFive(125, "5*5*5", "yellow"),
    oneHundredAndFourtyFour(144, "fibonacci-number", "green"),
    oneHundredAndFiftySix(156, "77+((7+7)/7)+77", "purple"),
    twoHundredAndSixtyNine(169, "13*13", "yellow"),
    twoHundred(200, "200", "blue"),
    twoHundredAndSeven(207, "207", "purple"),
    twoHundredAndSixteen(216, "6*6*6", "yellow"),
    twoHundredAndTwentyTwo(222, "super-master-number", "orange"),
    twoHundredAndTwentyFive(225, "15*15", "yellow"),
    twoHundredAndFiftySix(256, "16*16", "yellow"),
    ...
    threeHundredAndFourtyOne(341, "31*11", "purple"),
    ...
    fiveHundredTwentyNine(529, "23*23", "yellow"),
    ...
    eightHundredAndThirtySix(836, "weird number", "purple"),
    ...
    oneThousandAndNinetyEight(1089, "33*33", "yellow"),
    oneThousandOneHundredAndEleven(1111, "hyper-master-number", "orange"),
    oneThousandOneHundredAndFiftySix(1156, "34*34", "yellow"),
    oneThreeThreeOne(1331, "11*11*11", "yellow"),
    oneThreeThreeSeven(1337, "leet", "purple"),
    ...
    fourThousandAndThirty(4030, "weird number", "purple"),
    ...
    fiveEightThreeZero(5830, "weird number", "purple"),
    ...
    sevenOneNineTwo(7192, "weird number", "purple"),
    sevenSevenSevenSeven(7777, "hyper-master-number", "orange"),
    sevenNineOneTwo(7912, "weird number", "purple"),
    ...
    nineTwoSevenTwo(9272, "weird number", "purple"),
    ...
    private Highlight(final int number, final String numberQuality, final String color) {
    ...
    public final void setNumberQuality(final String numberQuality) {
        this.numberQuality = numberQuality;
    }

    public final String getNumberQuality() {
